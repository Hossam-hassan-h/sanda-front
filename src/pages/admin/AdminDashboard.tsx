  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-3">
        <StatsRow icon={<DollarSign className="h-4 w-4" />} label="إجمالي الإيرادات" value={`${data.heldAmount.toLocaleString()} ج`} />
        <StatsRow icon={<Clock className="h-4 w-4" />} label="بلاغات معلقة" value={data.openReports.toString()} />
        <StatsRow icon={<AlertTriangle className="h-4 w-4" />} label="وظائف نشطة" value={data.activeJobs.toString()} />
      </CardContent>
    </Card>
  );
}
